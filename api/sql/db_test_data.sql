...
INSERT INTO factiongroups (factiongroup_id, name) VALUES (2,'Empire-group');
INSERT INTO factiongroups (factiongroup_id, name) VALUES (1,'Alliance-group');

/* POPULATE factions
============================================= */

INSERT INTO factions (faction_id, name, factiongroup_id, color, logo) VALUES (2,'Empire',2,'248717','uploads/factions/84935fe3eba50ea4e3d70b7f7964b9c0.png');
...
INSERT INTO games (game_id, player1_faction_id, player2_faction_id, date, is_time_runout, is_draw, player1_id, player2_id, is_ranked, notes, is_online) VALUES (35, 0, 0, '2014-02-24 18:00:00', 0, 0, 3, 1, 1, '', 0);
INSERT INTO games (game_id, player1_faction_id, player2_faction_id, date, is_time_runout, is_draw, player1_id, player2_id, is_ranked, notes, is_online) VALUES (36, 1, 0, '2014-02-26 00:30:00', 0, 0, 1, 6, 1, 'sacrifié Carnor Jax comme un idiot (i.e. un radis) vers la fin, Roark a tout bouffé mes 4 vaisseaux tapochés.\n', 1);
