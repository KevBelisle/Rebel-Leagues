		...
		<div class="player_stats">
			...
			<div ng-switch on="ranking">
				...
				<div ng-switch-when="3">
					Points Elo : {{ player.elo_rating | number:0 }}
					<div class="stats_bar" ng-attr-style="width: {{ 10 + 90 * (player.elo_rating - min) / (max - min) | number:0 }} px"></div>
				</div>
				
				<div ng-switch-when="1">
					{{ player.games_played }} parties jouées
					<div ng-show="player.games_played" class="stats_bar" ng-attr-style="width: {{ 100 * player.games_played / max | number:0 }}%">
					
						<div class="faction_stats_bar" ng-repeat="faction_stats in player.factions_stats" ng-attr-style="width: {{ 99.99 * faction_stats.games_played_with / player.games_played | number:2 }}%;">
				...
				<div ng-switch-when="2">
					...
					<div class="stats_bar" ng-attr-style="width: {{ 100 * player.points / max | number:0 }}%">
						<div class="darker" style="width: 100%" tooltip="{{ player.points }} points"></div>
					</div>
				</div>
